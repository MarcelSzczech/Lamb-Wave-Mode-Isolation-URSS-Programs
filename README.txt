...
'frequency sweeps' contains signal data for 2 plate thicknesses, for a total of 5 time delays, for a range of frequencies usually ~0.2 MHz to ~1.1 MHz.

'~8.109mm' plate excitations contains signal data for an 8.109mm plate, for two time delays, as the frequency is moved across excitation bands of the
correpsonding FT heatmap. The signal file names contain in them the predicted excited modes for those frequencies, gleaned from the FT heatmap.
